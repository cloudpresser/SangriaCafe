...
export default ProfileCard = () => {
    ...
    :
    <View style={styles.userBar}>
        <Button title={ authOptionsVisible ? 'Sign In': loginIsVisible || registerIsVisible ? 'Options' : 'Sign In' } onPress={() => openAuthOptions()}/>
            { authOptionsVisible ? 
                <View>
            ...
            { registerIsVisible ? 
                <View style={styles.registerContainer}>
                    <TextInput style={styles.textInput} placeholder={'email'} autoCompleteType='email' onChangeText={changeEmail} value={email}/>
                    <TextInput style={styles.textInput} placeholder={'password'} onChangeText={changePassword} value={password}/>
                    <Button title='Create new account' style={{marginTop: 5}} onPress={() => postNewUser()}/>
